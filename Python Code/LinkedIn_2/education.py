...
def json_to_dicts(objects):
    ...
    for employee in objects:
        for education in employee.get('educations', ''):
            education['public-profile-url'] = employee.get('public-profile-url', '')
...
if __name__ == '__main__':
    ...
    if len(args) == 3:
        ...
        print 'Usage:'
        print 'python education.py "{JSON_ROOT_DIR}" "{OUTPUT_FILE_NAME}"'
########################